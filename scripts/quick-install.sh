...
echo "  Adjust settings: curl -fsSL https://raw.githubusercontent.com/${REPO}/main/scripts/configure.sh | sudo bash -s -- --time 0.15"
echo "  Check status: curl -fsSL https://raw.githubusercontent.com/${REPO}/main/scripts/status.sh | bash"
echo "  Uninstall: curl -fsSL https://raw.githubusercontent.com/${REPO}/main/scripts/quick-uninstall.sh | sudo bash"
echo ""
